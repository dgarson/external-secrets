...
// TestCache and TestCacheWithReferentSpec were removed as they tested the deprecated
// legacy cache functionality. Client caching is now handled by the ClientPool interface.
// See client_pool_caching_test.go for tests of the new caching mechanism.
